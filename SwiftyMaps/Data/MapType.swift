...
class CartoMapType : MapType{
    ...
    override func fillLicenseView(_ view: UIView){
        ...
        label.setAnchors(top: view.topAnchor, leading: view.leadingAnchor, bottom: view.bottomAnchor)
        label.text = "© "
        let link = UIButton()
        link.setTitleColor(.systemBlue, for: .normal)
        link.titleLabel?.font = .preferredFont(forTextStyle: .footnote)
        view.addSubview(link)
        link.setAnchors(top: view.topAnchor, leading: label.trailingAnchor, bottom: view.bottomAnchor)
...
class TopoMapType : MapType{
    ...
    override func fillLicenseView(_ view: UIView){
        ...
        label.font = .preferredFont(forTextStyle: .footnote)
        view.addSubview(label)
        label.setAnchors(top: view.topAnchor, leading: link.trailingAnchor, bottom: view.bottomAnchor)
