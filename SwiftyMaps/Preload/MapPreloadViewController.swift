...
class MapPreloadViewController: PopupViewController{
    ...
    override func loadView() {
        ...
        header.setAnchors(top: contentView.topAnchor, leading: nil, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        ...
        note1.setAnchors(top: header.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, bottom: nil, insets: Insets.defaultInsets)
        let note2 = UILabel()
        note2.numberOfLines = 0
        note2.lineBreakMode = .byWordWrapping
        note2.text = "mapPreloadNote2".localize()
        contentView.addSubview(note2)
        note2.setAnchors(top: note1.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, bottom: nil, insets: Insets.defaultInsets)
        
        let allTilesLabel = UILabel()
        allTilesLabel.text = "allTilesForDownload".localize()
        contentView.addSubview(allTilesLabel)
        allTilesLabel.setAnchors(top: note2.bottomAnchor, leading: contentView.leadingAnchor, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        contentView.addSubview(allTilesValueLabel)
        allTilesValueLabel.setAnchors(top: note2.bottomAnchor, leading: allTilesLabel.trailingAnchor, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        
        let existingTilesLabel = UILabel()
        existingTilesLabel.text = "existingTiles".localize()
        contentView.addSubview(existingTilesLabel)
        existingTilesLabel.setAnchors(top: allTilesLabel.bottomAnchor, leading: contentView.leadingAnchor, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        ...
        tilesToLoadLabel.setAnchors(top: existingTilesLabel.bottomAnchor, leading: contentView.leadingAnchor, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        ...
        maxZoomLabel.setAnchors(top: tilesToLoadLabel.bottomAnchor, leading: contentView.leadingAnchor, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        ...
        maxZoomSlider.setAnchors(top: maxZoomLabel.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, bottom: nil, insets: Insets.defaultInsets)
        ...
        startButton.setAnchors(top: maxZoomSlider.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.centerXAnchor, bottom: nil, insets: Insets.defaultInsets)
        ...
        cancelButton.setAnchors(top: maxZoomSlider.bottomAnchor, leading: contentView.centerXAnchor, trailing: contentView.trailingAnchor, bottom: nil, insets: Insets.defaultInsets)
        ...
        loadedTilesSlider.setAnchors(top: startButton.bottomAnchor, leading: contentView.leadingAnchor, trailing: contentView.trailingAnchor, bottom: nil, insets: Insets.doubleInsets)
        
        let errorsInfo = UILabel()
        errorsInfo.text = "unloadedTiles".localize()
        contentView.addSubview(errorsInfo)
        errorsInfo.setAnchors(top: loadedTilesSlider.bottomAnchor, leading: contentView.leadingAnchor, trailing: nil, bottom: nil, insets: Insets.defaultInsets)
        ...
        closeButton.setAnchors(top: errorsInfo.bottomAnchor, leading: nil, trailing: nil, bottom: contentView.bottomAnchor, insets: Insets.defaultInsets)
            .centerX(contentView.centerXAnchor)
