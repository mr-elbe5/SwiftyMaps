...
/*class MainViewController: MapViewController {
    ...
    func fillMenu() {
        ...
        mapButton.setAnchors()
                .top(menuView.topAnchor, inset: Insets.defaultInset)
                .leading(menuView.leadingAnchor, inset: Insets.defaultInset)
                .bottom(menuView.bottomAnchor, inset: Insets.defaultInset)
        ...
        searchButton.setAnchors()
                .top(menuView.topAnchor, inset: Insets.defaultInset)
                .trailing(menuView.centerXAnchor, inset: Insets.defaultInset)
                .bottom(menuView.bottomAnchor, inset: Insets.defaultInset)
        cameraButton.setAnchors()
                .top(menuView.topAnchor, inset: Insets.defaultInset)
                .leading(menuView.centerXAnchor, inset: Insets.defaultInset)
                .bottom(menuView.bottomAnchor, inset: Insets.defaultInset)

        infoButton.setAnchors()
                .top(menuView.topAnchor, inset: Insets.defaultInset)
                .trailing(menuView.trailingAnchor, inset: Insets.defaultInset)
                .bottom(menuView.bottomAnchor, inset: Insets.defaultInset)
    ...
    func fillStatus() {
        ...
        statusLabel.setAnchors()
                .top(statusView.topAnchor, inset: Insets.defaultInset)
                .centerX(statusView.centerXAnchor)
                .bottom(statusView.bottomAnchor)
        centerButton.setAnchors()
                .top(statusView.topAnchor, inset: Insets.defaultInset)
                .leading(statusLabel.trailingAnchor, inset: Insets.defaultInset)
                .bottom(statusView.bottomAnchor)
        refreshButton.setAnchors()
                .top(statusView.topAnchor, inset: Insets.defaultInset)
                .trailing(statusView.trailingAnchor, inset: Insets.defaultInset)
                .bottom(statusView.bottomAnchor)
    }
